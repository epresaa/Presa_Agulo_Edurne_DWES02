...
<html lang='es'>
    ...
    <!-- Formulario -->
        <form action="php/request.php" method="post">
            ...
            <input type="textarea" name="apellidos" id="apellidos">
            <br><br><br>

            <!-- Título del libro -->
            <label>Libro</label><br>
            <input type="textarea" name="libro" id="libro">
            <br><br><br>
            ...
            <input type="textarea" name="tel" id="tel">
            <br><br><br>       
            ...
            <!-- DNI -->
            <label>DNI</label><br>
            <input type="textarea" name="dni" id="dni">
            <br><br>
